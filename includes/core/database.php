...
class MySQLDatabase{
  ...
  public function open_connection(){
    ...
    $this->connection=mysqli_connect(self::$_DB_SERVER, self::$_DB_USER, self::$_DB_PASS, self::$_DB_NAME);
    if(!$this->connection){
...
/**creating a new object of the MySQLDatabase class
  pass the database constants as parameters for creation of the database
  $database = new MySQLDatabase($DB_SERVER, $DB_USER, $DB_PASSWORD, $DB_NAME)
**/
$database=new MySQLDatabase("localhost", "root", "ROGERS1.inc", "police_sec");
?>
